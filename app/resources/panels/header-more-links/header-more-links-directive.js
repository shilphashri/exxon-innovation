(function() {
  ...
  angular
    .module('app')
    .directive('headerMoreLinks', headerMoreLinks);

    headerMoreLinks.$inject = ["panelService", "assetsCdnPath", "assetsVersion"];

  function headerMoreLinks(panelService, assetsCdnPath, assetsVersion) {
    var directive = {
      scope: {
        uniqueId : '@',
        panelData: '@',
      ...
      restrict: 'AE',
      templateUrl: 'app/resources/panels/header-more-links/header-more-links.html',
      link: link
    }
    return directive;
    ...
    function link(scope, ele, attributes) {
      ...
      function menuClick() {
        var nativeElement = jQuery('header-more-links');
