(function() {
  ...
  angular
    .module('app')
    .directive('condensedHeader', condensedHeader);

    condensedHeader.$inject = ['panelService', 'assetsCdnPath' , 'assetsVersion']

  function condensedHeader(panelService, assetsCdnPath , assetsVersion) {
    var directive = {
      scope: {
        uniqueId : '@',
        panelData: '@',
      ...
      restrict: 'AE',
      templateUrl: 'app/resources/panels/condensed-header/condensed-header.html',
      link: link
    }
    return directive;
    ...
    function link(scope, ele, attributes) {
      ...
      function menuClick() {
        var nativeElement = jQuery('condensed-header');
